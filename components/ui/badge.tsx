...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-(--radius-xs) border px-2 py-0.5 text-(length:--text-2xs) font-semibold uppercase tracking-wide [&_svg]:size-3 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        neutral:
